  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 24 24" fill="#ff6b9d" className="absolute top-0 right-0 rotate-8 opacity-50 w-12 h-12">
            ...
            <div className="relative h-96 rounded-lg ">
              <svg xmlns="http://www.w3.org/2000/svg" className="absolute -bottom-18 right-0 rotate-8 opacity-50 w-12 h-12" width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="#ff6b9d" stroke-width="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <section className="bg-gray-100 relative py-20 px-12">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" className="absolute top-18 left-8 rotate-8 animate-bounce transition-all duration-300 opacity-70 w-12 h-12" width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="#ff6b9d" stroke-width="2" strokeLinecap="round" stroke-linejoin="round">
          <path d="M12 2a4 4 0 0 0-4 4h8a4 4 0 0 0-4-4z" />
          <path d="M5 11h14v2H5z" />
          <path d="M6.5 15l1.5 6h8l1.5-6z" />
        </svg>
        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="#ff6b9d" viewBox="0 0 24 24" className="absolute top-18 right-8 -rotate-8 animate-bounce transition-all duration-300 opacity-70 w-12 h-12">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-card rounded-2xl p-8 text-center border hover:border-primary/50 transition-all duration-300 hover:-translate-y-1">
      ...
      <section className="py-16 px-12 relative">
        <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 200 200" fill="#ff6b9d" className="absolute top-8 rotate-6 left-4 w-16 h-16">

          <ellipse cx="100" cy="140" rx="70" ry="20" fill="#ff6b9d" stroke="#ff6b9d" strokeWidth="4" />
          <rect x="30" y="60" width="140" height="80" fill="#ff6b9d" stroke="#ff6b9d" strokeWidth="4" />
          <ellipse cx="100" cy="60" rx="70" ry="20" fill="#fff" stroke="#ff6b9d" strokeWidth="4" />

          <circle cx="60" cy="50" r="8" fill="#ff6b9d" stroke="white" strokeWidth="2" />
          <circle cx="100" cy="40" r="8" fill="#ff6b9d" stroke="white" strokeWidth="2" />
          <circle cx="140" cy="50" r="8" fill="#ff6b9d" stroke="white" strokeWidth="2" />
        </svg>


        <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 5 200" fill="#ff6b9d" className="absolute top-4 -right-[0px] pl-2">
          <path
      ...
      <section className="py-20 px-12 relative">
        <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 200 200" fill="#ff6b9d" className="absolute top-0 -left-25">
          <path
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 200 200" fill="#ff6b9d" className="absolute top-8 right-8 w-18  -rotate-6 h-18">

          <path d="M40 100 A60 40 0 0 1 160 100" fill="none" stroke="#ff6b9d" stroke-width="4" />

          <line x1="30" y1="100" x2="170" y2="100" stroke="#ff6b9d" stroke-width="4" />

          <rect x="90" y="100" width="20" height="40" fill="#ff6b9d" />
          <ellipse cx="100" cy="140" rx="40" ry="8" fill="#ff6b9d" />
        </svg>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {values.map((value, index) => (
              <div
                key={index}
                className="group bg-card rounded-2xl p-8 border hover:border-primary/50 transition-all duration-300 hover:translate-y-1"
              >
